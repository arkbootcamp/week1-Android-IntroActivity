...
class HeaderInterceptor (val mContext: Context) : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response = chain.run {
        ...
        val tokenAuth = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjo2LCJ1c2VyX25hbWUiOiJSb3N5aWRhIiwidXNlcl9lbWFpbCI6InJvc3lpZGFAZ21haWwuY29tIiwidXNlcl9yb2xlIjoxLCJ1c2VyX3N0YXR1cyI6MCwiaWF0IjoxNjAyMjMwNzY1LCJleHAiOjE2MDIyMzQzNjV9.RnryQWsbFlpYPrtSXtudNM5iOUn0wwTyxNx30ckQNsU"
        proceed(
            request().newBuilder()
